...
# This function is called for all k trials. It returns false if n is composite and returns false if n is
# probably prime. d is an odd number such that d*2<sup>r</sup> = n-1 for some r >= 1
def miillerTest(d, n):
