public class PTMR {
    ...
    // returns false if n is probably prime. d is an odd number such that d*2<sup>r</sup> = n-1 for some r >= 1
    ...
    // prime. k is an input parameter that determines accuracy level. Higher
